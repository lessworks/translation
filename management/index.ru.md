...
LeSS оказывает огромное влияние на управление в организациях. Требуется особый стиль управления, отличный от традиционного, заключающегося в контроле над подчинёнными. Это больше всего похоже на принцип "Менеджеры как Учителя", пропагандируемый в [Бережливом Мышлении](../principles/lean-thinking.html)
...
Одна важная концепция для понимания управления в LeSS — две различных крайности в стилях управления, называемых также Теория X и Теория Y (первый придуман Дугласом МакГрегором (Douglas McGregor) в [The Human Side of Enterprise](http://www.amazon.com/Human-Side-Enterprise-Annotated-Edition/dp/0071462228).
...
МакГрегор предлагает следующие предположения Теории Y:
