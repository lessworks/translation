...
Мы видели успешное внедрение масштабируемого Скрама в распределённой продуктовой группе из тысячи человек с несколькими Excel-таблицами для с Бэклогом Продукта и диаграммой Сгорания Релиза. Действительно, они почти наверняка лучше для этих целей; это держит внимание команды в большей степени на улучшении системы.

Инструменты для Agile-менеджмента, которые мы видели, выделяет отслеживание и отображение индивидуальных или командных задач в Бэклоге Спринта для менеджеров - почти противоположность этим принципам. В Скраме, задачи команд (Бэклог Спринта) создаются командами, чтобы помочь им в самоорганизации - а не для предоставления отчётности кому-либо. Хорошо известный исследователь команд Ричард Хакман объясняет *“В самоорганизованных командах ответственность за отслеживание прогресса делегирована напрямую командам”* [[Hackman02]](http://www.amazon.com/Leading-Teams-Setting-Stage-Performances/dp/1578513332). С тех пор, как команда становится самоорганизованной, она не отслеживается и не проверяется; такие инструменты представляют собой скользкий путь, который может укрепить традиционную культуру раздачи команд и их контроля, а не культуру самоуправления.

Компьютеризированные инструменты для управленческой отчётности могут отдалять людей от гемба и практики Пойди и Посмотри. Бережливое мышление подчёркивает - чтобы понять, что по-настоящему происходит - отправьтесь на своих ногах и смотрите своим глазами на место выполнения работы, помогайте решать проблемы, и постройте взаимоотношения с рабочими там.
