...
Наш пример - это не более чем просто пример. Диаграмма причинно-следственных связей может визуализировать богатую динамику системы рабочего окружения. Её создавать лучше всего группой на доске.
