...
С помощью словаря быстрых исправлений, задержек, петель положительной обратной связи и ментальных моделей интересно видеть, что может быть краткосрочное очевидное улучшение переменной в результате быстрого исправления, но *замедленная деградация* той же самой переменной-динамика “быстрее медленнее”. Это повторяющаяся динамика на рабочем месте и причина слабости. Так что стоит привести еще одну иллюстрацию.
