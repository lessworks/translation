...
* *Общее* глобальное сокращение времени релизного цикла, которое может случиться благодаря ликвидации очередей и применению практик управления очередями, таким образом многие циклы разработки становятся короче.
