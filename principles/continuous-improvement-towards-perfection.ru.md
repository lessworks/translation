...
Естественно, группа, внедряющая LeSS привносит своё понимание и привычки по части принятия, улучшения и изменений. Так ведь? Создаёт видение изменений и запускает несколько проектов по изменениям. Когда изначальная цель (например, "внедрить LeSS") по всей видимости достигнута, тогда:
...
*Непрерывное улучшение на пути к совершенству* является одним из двух столпов  [Бережливого Мышления](./lean-thinking.html), а также принципом LeSS. Поскольку бережливое мышление---так же, как и непрерывное совершенствование---изначально пришло из Toyota, некоторая часть настоящей главы опирается на опыт Toyota.
