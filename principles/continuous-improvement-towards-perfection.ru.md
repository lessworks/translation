...
Конституция должна быть краткой и непонятной.
<br/>
—Наполеон Бонапарт
</p></div>
...
Естественно, группа, внедряющая LeSS превностит своё понимание и привычки по части принятия, улучшения и изменений. Так ведь? Попробуйте создать видение изменений и запустить несколько проектов по изменениям. Когда изначальная цель (например, "внедрить LeSS") по всей видимости достигнута, тогда:
...
Этот классический подход похож на последовательный и "крупномасштабный" подход разработки программного обеспечения в котором изменение - это исключение, строго управляемое… множественными комиссиями по контролю изменений.

В LeSS не существует инициатив по изменениям, групп по изменениям, не существует менеджеров по изменениям. В LeSS изменения происходят непрерывно посредством экспериментов и улучшений, изменения  в LeSS - это статус-кво. Когда вы успешно завершили внедрение LeSS? Никогда. Когда вы закончили изменения? Никогда.

Тогда что такое *совершенство*? Это не совсем правильный ответ, но например:

* продукт функционирует идеально, и глубоко удовлетворяет заказчика; продукт потрясающе популярен и прибылен
...
*Непрервыное улучшение на пути к совершенству* является одним из двух столпов  [Бережливого Мышления](./lean-thinking.html), а также принципом LeSS. Поскольку бережливое мышление, так же, как и непрерывное совершенствование, изначально пришло из Toyota, некоторые из этих вводных опираются на опыт Toyota.
...
Нам известны менеджеры в LeSS организациях,  которые отказались от своих отдельных офисов  (в пользу командных комнат). И сидя непосредственно рядом с разработчиками, они были очень удивлены тем, что *на самом деле* происходит, даже не смотря на то, что проработали до этого годы со своей группой .
...
Пойди и Посмотри на **гемба**. Что и где это такое - *гемба*? *Гемба* означает не место вспомогательной или второстепенной работы по учёту или по чему-либо подобному, это означает место работы, создающую реальную ценность, которая непосредственно создаёт продукт или услугу которая действительно заботит  *платящего клиента*. Например, место где люди пишут свой код, который решает реальные проблемы клиентов и т.п. И гемба - это не комната переговоров или офис недалеко от рабочих!
...
**В бережливом мышлении, стандартизированная работа *не* означает соответствие единым стандартам**---Грубейшим недопониманим в бережливом мышлении является заблуждение о том, что “стандартизированная работа” означает соответсвие неким централизованным стандартам. Это настолько грубая  ошибка с точки зрения бережливого подхода, всё ещё часто недопонимаемая, что этот момент заслуживает особого внимания. Скорее, идея состоит в том, чтобы команда освоила основы, относительно которых можно было бы сравнить результаты экспериментов по улучшению. Эти основы—тот самый стандарт—создаются самими командами (а на какими-то централизованными группами по стандартизации) и являются постоянно-эволюционирующими. Как сказал Тайити Оно:
...
> Определяющая характеристика корпоративной культуры в Toyota - это то, что менедежеры не будут ругать вас за проявление инициативы, за то, что вы рискнули и облажались. Скорее, они отчитают вас за то, что вы не пытались попробовать что-то новое, за то, что вы не попытались рискнуть. Лидеры здесь не для того чтобы осуждать. Они для того, чтобы поддерживать людей. Вот что я постоянно пытался сделать. Пробы и ошибки - вот о чём всё это!
...
Кайдзен отражает цикл улучшений [Plan-Do-Check-Act (PDCA)](https://en.wikipedia.org/wiki/PDCA) Уолтера Шухарт (также известный как цикл Деминга). На самом деле много людей в Toyota формально знают о PDCA и иногда описывают то, что они делают как “бесконечный PDCA”.
