...
Диаграммы причинно-следственных связей часто используются при ознакомлении с LeSS, чтобы увидеть системную динамику того, что происходит при разработке больших систем. Уже только ради этой цели имеет смысл понять её. Ещё полезнее, сделать это вместе с коллегами у доски. Моделируйте ради обсуждения. Когда? Например, во время всеобщей ретроспективы LeSS.

Практическая ценность этого совета более важна, чем может показаться на первый взгляд. Очень расплывчато и малорезультативно "быть системномыслящим". Но если вы и четверо ваших коллег возьмёте за привычку вставать вместе у большой доски и разрабатывать диаграмму причинно-следственных связей, это уже конкретная и потенциально высокорезультативная практика, которая связывает "*быть* системномыслящим" с "*мыслить* системно".
...
**Цели и реакции**{: style="color: #1997C0"}--Люди, подразделения и системы имеют цели, такие как *увеличение скорости разработки фичи*. Цели часто заставляют людей реагировать (или действовать) с намерением достичь цель. Но, принимая по внимание *Ловушку причинно-следственной связи* и *Закон Вайнберга-Брукса*, необходимо быть осторожными, полагая, что действия могут помочь. Цель и порождённые ей действия показаны на рисунке:
...
Нет никаких гарантий, что скорость разработки фич улучшилась---или даже просто осталась прежней.

Отказ от системы наград - решение корневой причины дисфункции измерений. Другое (менее предпочтительное) лежащее на поверхности решение - это принцип бережливого мышления *Сходить Посмотреть* (физически сходить посмотреть на место, где выполняется реальная работа):

![systems thinking-11.png](/img/systems_thinking/systems%20thinking-11.png)

**Скороспелые реакции**{: style="color: #1997C0"}---Одно из сложных и медленных решений в достижении цели увеличения скорости разработки фич - нанять крутых разработчиков, увеличить степень обучения и коучинга текущей команды, уволить неудовлетворительных сотрудников. Альтернативное решение, называемое *скороспелым*, основывается на быстром достижении цели с минимальными усилиями. Иногда такое решение работает в кратко- и долгосрочной перспективе, действительно укрепляя систему. Но "иногда" не значит "следовательно", "Тише едешь – дальше будешь" ... Например, люди могут *полагать*, что увеличение количества разработчиков увеличит скорость разработки фич. И, тем самым, они могут надеяться, что найм большего количества разработчиков - самый быстрый и простой способ решить проблему со скоростью разработки. Символы ‘QF’ обозначают скороспелое решение:

![systems thinking-12.png](/img/systems_thinking/systems%20thinking-12.png)

**Эффекты взаимодействия**{: style="color: #1997C0"}---Есть ограничения по предлагаемой зар.плате при найме. Одно из сложных и медленных решений - увеличить предлагаемую зар.плату. Скороспелое решение - нанять разработчиков с *намного* меньшей зар.платой. В этом случае уровень зар.платы оказывает *эффект взаимодействия* на другие причинные связи. Предложение более низкой зар.платы приводит к увеличению скорости найма более дешевых разработчиков когда нужно нанимать больше разработчиков.

Кто-то мог бы просто нарисовать (обратную) причинную связь напрямую из *зар.плата* к *скорость найма очнеь дешёвых разработчиков*, но это всего лишь говорит, что меньшая зар.плата приводит к увеличению найма очень дешёвых разработчиков. Это не совсем то, что мы хотим сказать; скорее, мы хотим показать эффект взаимодействия---что взаимодействие А влияет на "взаимодействие" B. Это можно показать, если одну причинную связь подвести к другой причинной связи. Например, скороспелое решение идёт от *зар.платы* к *скорости найма очень дешёвых разработчиков*:
