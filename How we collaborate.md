...
**Когда начинаешь перевод новой страницы**

1. В первой колонке Trello создайте карточку со ссылкой на страничку, которую готовы перевести
1. Напишите в Telegram Ивану (@ivanz), чтобы он прикрепил исходники. Он после прикрепления переносит ее в колонку Source Attached.
...
2. После ревью коллеги-контрибьютора cделайте коммит изменений. После одобрения исходник и перевод появляются в master 
3. Далее перенесите карточку Trello в Publish
4. Не забывайте добавлять себя и коллег ревьюверов в конце перевода :)
