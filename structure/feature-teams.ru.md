...
Иногда этого не видно, но структура компонентных команд усиливает модель последовательной разработки (‘водопад’ или V-модель), с большим количеством очередей с разноразмерными пакетам работ, высоким уровнем НЗР, множественными передачами, повышенной многозадачность и частичным выделением людей на проекты.
