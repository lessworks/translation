...
* Роль менеджмента – это улучшение продуктовой разработки компании за счет практики подхода [Go See](/less/principles/continuous-improvement-towards-perfection.html#GoSee), и продвижения подхода Stop & Fix, а также «экспериментирование важнее соответствия».
