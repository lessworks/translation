...
В середине Спринта они проводят многокомандное Уточнение Бэклога вместе со второй командой, которую планируется вскоре присоединить к Области, рассказывая им обо всём, что связано с законом Додда-Франка. Они проводят совместную сесиию по изучению текущей архитектуры, чтобы познакомить команду с основными блоками дизайна, которые уже существуют.
...
### • История LeSS Huge: Распределённые Команды •
